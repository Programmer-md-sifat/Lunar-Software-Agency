  ...
  const stats: StatItem[] = [
    {
      ...
      subtitle: "System architecture expertise that drives scalable results.",
    ...
    },
    {
      ...
      subtitle: "High-availability web & mobile apps built with purpose.",
    ...
    },
    {
      ...
      subtitle: "From initial architecture strategy to standout continuous scale.",
